...
cp -a $SANDMARK_NIGHTLY_DIR/sandmark/_results/*.bench $SANDMARK_NIGHTLY_DIR/sandmark-nightly/sequential/$TIMESTAMP/$OCAML_412_DOMAINS_EFFECTS
rm -rf _results/
...
cp -a $SANDMARK_NIGHTLY_DIR/sandmark/_results/*.bench $SANDMARK_NIGHTLY_DIR/sandmark-nightly/parallel/$TIMESTAMP/$OCAML_412_DOMAINS_EFFECTS
rm -rf _results/
